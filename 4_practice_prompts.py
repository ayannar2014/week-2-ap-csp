...
# print the length of the summary x
# upper case the entire summary x
# print the summary x
# print the summary in lowercase 
# replace the word blue with red
# print the summary x
# string index the word beetle and print it out x
# print the last word of the summary x
# print the summary in reverse x
...
print(f"Your name is {name2} and your favorite color is {color}.")
